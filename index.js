...
function createMenuItem(item, price, itemType) {
  const lunch = {};
  lunch.name = item;
  lunch.price = price;
  lunch.category = itemType;
  return lunch;
}
...
console.log("task 1b", createMenuItem("burger", 3, "dinner"));
console.log("task 1b", createMenuItem("pizza", 5, "lunch"));
console.log("task 1b", createMenuItem("salad", 2, "appetizer"));

/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 2: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀
You're having a lunch special! 25% off for teachers and students, 10% off for everyone else. Add a method to the burger object below that automatically 
calculates price depending on the string received as a parameter. 
...
Using the burger object below do the following:
  ...
  4. Check your work by invoking the function and passing in 'teacher', 'student', or 'public' as your arguments to ensure they are returning the 
  correct price.
